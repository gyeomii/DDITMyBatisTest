...
public class MemberInfoMain {
	...
	private void insertMember() {
		...
		if (cnt > 0) {
			System.out.println(mv.getMemId() + "회원 등록 완료");
		} else {
			System.out.println(mv.getMemId() + "회원 등록 실패");
		}
	}
	...
	private void updateMember() {
		...
		if (cnt > 0) {
			System.out.println(mv.getMemId() + "회원 정보 수정 완료");
		} else {
			System.out.println(mv.getMemId() + "회원 정보 수정 실패");
		}
	}
